...
namespace Rehber
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=.;Initial Catalog=DbRehber;Integrated Security=True");
        private void button2_Click(object sender, EventArgs e)
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from kisiler where ID=" + txtId.Text, baglanti);
            DialogResult dialogResult = MessageBox.Show("Kişiyi silmek istediğinizden emin misiniz?", "Uyarı", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
